...
2. Read and show the relevant current state first. Use `get_ai_credit_usage`, `list_ai_credit_events`, `get_api_credit_usage`, `get_email_usage`, or storage reads before a large or costly workflow when usage is material.
